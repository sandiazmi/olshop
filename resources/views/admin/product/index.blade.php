                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $product->price }}</td>
                            <td>
                                <a href="{{ route('product.edit', $product) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                <button href="{{ route('product.destroy', $product) }}" id="delete"
                                    data-title="{{ $product->title }}" class="btn btn-danger btn-sm">
